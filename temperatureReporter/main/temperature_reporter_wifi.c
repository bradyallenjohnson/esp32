/*
 * Temperature reporter WIFI handling.
 *
...
static const char *TAG = "TempReporterWifi";
...
static void event_handler(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data)
{
    ...
    if (arg != NULL) {
        esp_event_handler_t chained_event_handler = (esp_event_handler_t) arg;
        chained_event_handler(NULL, event_base, event_id, event_data);
    }
}
